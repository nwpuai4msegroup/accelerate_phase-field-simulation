...
model = load_model('/home/zongbangtan/conv_LSTM/autoencoder-sigmoid/Reconstruction_model_2/autoencoder.hdf5')
...
print("encoded_image_shape:",encoded_images.shape)

convlstm_input = []

for i in range(0,9960):
  temp = encoded_images[i:i+10,...]  #选取前10帧图像，每两个连续帧为400steps
...
inp = tf.keras.layers.Input(shape=(None, 32,32,16))
...
checkpoint_filepath ='/home/zongbangtan/conv_LSTM/LSTM/2layer/10.2_test/LSTM_Model_1/lstm_model_60.hdf5'
